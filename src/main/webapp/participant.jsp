...
<div class="container">
	...
	<nav aria-label="breadcrumb" class="mt-4">
		<ol class="breadcrumb">
			<li class="breadcrumb-item link-primary pointer"
				onclick="loadMainEvent()">All Events</li>
			<li class="breadcrumb-item link-primary pointer" onclick="loadSubEvent('<%=me_id%>', '<%= me_title%>')"><%=me_title%></li>
	...
	<div class="d-flex justify-content-end align-items-center mt-3">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="d-flex justify-content-end">
							<button type="button" class="btn btn-secondary"
								onclick="addNewParticipantsInBulk('<%=me_id%>', '<%=se_id%>')">Parse
								data</button>
						</div>
					</div>
				</div>
		...
		<div class="modal" tabindex="-1" role="dialog" id="parsedRollNos">
			<div class="modal-dialog  modal-lg modal-dialog-centered"
				role="document" id="table-bulk-content">
